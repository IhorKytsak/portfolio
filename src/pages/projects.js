      ...
      <div className='w-1/2 flex flex-col items-start justify-between pl-6'>
        ...
        <div className='mt-2 flex items-center'>
          ...
          <Link
            href={link}
            target='_blank'
            className='ml-4 rounded-lg bg-dark text-light py-2 px-6 text-lg font-semibold dark:bg-light dark:text-dark'
          >
            Visit Project
          </Link>
        </div>
...
const Project = ({ type, title, img, link, github }) => {
  return (
    <article className='w-full flex flex-col items-center justify-center rounded-2xl border border-solid border-dark bg-light shadow- xl p-6 relative dark:bg-dark dark:border-light'>
