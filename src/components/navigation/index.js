    ...
    <header className='w-full px-32 py-8 font-medium flex items-center justify-between dark:text-light relative z-10 lg:px-16 md:px-12 sm:px-8'>
      ...
      {isOpen ? (
        <motion.div
          ...
          className='min-w-[70vw] flex justify-between items-center flex-col z-30 fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-light2/75 dark:bg-dark2/80 rounded-lg backdrop-blur-md py-32'
        >
